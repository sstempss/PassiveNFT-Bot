...
📋 Чтобы ознакомиться со стоимостью подписок и узнать, что в них входит, нажмите "💎 Подписки"
...
🎯 Готовы начать? Выбирайте свой план!"""
        ...
        self.SUBSCRIPTION_DESCRIPTION = "💳 Нажмите на интересующую вас подписку"
...
⚠️ ВАЖНО: Скопируйте адрес кошелька и отправьте указанную сумму TON."""
        ...
        self.REFERRAL_WELCOME_MESSAGE = """🎉 Добро пожаловать в PassiveNFT! 💎
