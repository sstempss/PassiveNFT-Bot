        ...
        self.STAR_SUBSCRIPTION_PLANS = [
            {
                ...
                "ton_price": 0.2,
                "lot_cost": 15,
                "description": """за вход в стоимость в 25 ЗВЕЗДОЧЕК вы получи шанс приумножить свои вложения вплоть до х20, всё зависит лишь от вашей скорости и удачи.
...
✅ суммарно розыгрываемых ГИФТОВ на сумму в 6000 звездочек
...
выдачи происходят в течении 5-7 минут после завершения активности."""
            },
            {
                ...
                "ton_price": 0.4,
                "lot_cost": 25,
                "description": """за вход в стоимость в 50 ЗВЕЗДОЧЕК вы получи шанс приумножить свои вложения вплоть до х20, всё зависит лишь от вашей скорости и удачи.
...
✅ 13 активнотей в ДЕНЬ
✅ 390 активностей в МЕСЯЦ
✅ суммарно розыгрываемых ГИФТОВ на сумму в 10000 звездочек
...
выдачи происходят в течении 5-7 минут после завершения активности."""
            },
            {
                ...
                "ton_price": 0.6,
                "lot_cost": 50,
                "description": """за вход в стоимость в 75 ЗВЕЗДОЧЕК вы получи шанс приумножить свои вложения вплоть до х20, всё зависит лишь от вашей скорости и удачи.
...
✅ 13 активнотей в ДЕНЬ
✅ 390 активностей в МЕСЯЦ
✅ суммарно розыгрываемых ГИФТОВ на сумму в 20000 звездочек
...
выдачи происходят в течении 5-7 минут после завершения активности."""
            },
            {
                ...
                "ton_price": 0.8,
                "lot_cost": 50,
                "description": """за вход в стоимость в 100 ЗВЕЗДОЧЕК вы получите шанс приумножить свои вложения вплоть до х20, всё зависит лишь от вашей скорости и удачи.
...
✅ 13 активнотей в ДЕНЬ
✅ 390 активностей в МЕСЯЦ
✅ суммарно розыгрываемых ГИФТОВ на сумму в 30000 звездочек
...
выберите подходящую для вас стоимости подписки и ознакомьтесь с тем, что входит в нее."""
...
После оплаты обратитесь к менеджеру @{self.config.MANAGER_USERNAME}"""
    ...
    async def help_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        logger.info(f"🎯 КОМАНДА ПОЛУЧЕНА: /help от пользователя {update.effective_user.id}")
        try:
...
💬 Для вопросов: @{self.config.MANAGER_USERNAME}"""
            ...
            logger.info(f"✅ /help выполнен для пользователя {update.effective_user.id}")
        except Exception as e:
